<template>
  <section style="margin-top:20px;">
    	...
    	<el-form-item>
				...
				<el-form-item>
					<el-button type="primary" v-on:click="getHistoryOrder">查询</el-button>
				</el-form-item>
			</el-form>
		</el-col>
...
export default {
  ...
  methods: {
    ...
    getHistoryOrder() {
      ...
      getHistoryOrderList(para).then(res => {
        this.historyTotal = res.data.date.totalCount;
        this.historyOrder = res.data.date.list;
        this.Loading = false;
        //NProgress.done();
      });
    },
